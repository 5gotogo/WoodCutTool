...
const translations = {
  ...
  es: {
    ...
    "Download Stringer": "Descargar Stringer",
    "Home": "Inicio",
  ...
  pt: {
    ...
    "Download Stringer": "Baixar Stringer",
    "Home": "Início",
  ...
  fr: {
    ...
    "Download Stringer": "Télécharger Stringer",
    "Home": "Accueil",
  ...
  de: {
    ...
    "Download Stringer": "Stringer laden",
    "Home": "Start",
    "Sitemap": "Sitemap",
    "Tile": "Fliesen",
    "Stringer": "Treppe",
  ...
  it: {
    ...
    "Download Stringer": "Scarica Stringer",
    "Home": "Home",
  ...
  ar: {
    ...
    "Download Stringer": "تنزيل Stringer",
    "Home": "الرئيسية",
  ...
  ja: {
    ...
    "Download Stringer": "Stringer をダウンロード",
    "Home": "ホーム",
    "Sitemap": "サイトマップ",
    "Tile": "タイル",
    "Stringer": "階段",
...
const dutchTranslations = {
  ...
  "Download Stringer": "Stringer downloaden",
  "Email:": "E-mail:",
...
function initApp() {
  if (window.WCTAppInitialized) return;
  window.WCTAppInitialized = true;
  initI18n();
  initHeroCutPlanner();
  initCutList();
  initPlywood();
