...
function detailPage(sourceEntry) {
  ...
  return pageShell({
    ...
    <header class="project-hero">
      ...
      <figure class="project-hero-visual"><img src="${image}" srcset="${image.replace(/\.webp$/, "-480.webp")} 480w, ${image} 960w" sizes="(max-width: 760px) calc(100vw - 32px), 440px" width="960" height="720" loading="eager" fetchpriority="high" alt="Workshop reference for ${esc(entry.category.toLowerCase())} project planning"><figcaption>Use the outcome to orient the work, then verify every real dimension, product, and release boundary.</figcaption></figure>
    </header>
