...
export function handoffMarkup(project) {
  ...
  return `<section data-cut-handoff data-scenario="${project.scenario}"><h2>Use this list in the calculator</h2><p>Review the material groups, thickness and orientation before calculating. Your edited list stays in this browser.</p><button class="button" type="button" data-send-cut-list>Use this cut list</button><p role="status" data-handoff-status></p><noscript>Enable JavaScript to transfer the list, or use the visible parts table.</noscript><script type="application/json" data-handoff-payload>${json}</script></section><script type="module" src="/assets/cut-handoff.js"></script>`;
}
